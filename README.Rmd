...
The goal of regexcite is to make using regular expressions exciting!
It provides convenience functions to make common tasks with string manipulation a bit easier.
